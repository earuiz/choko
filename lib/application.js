...
/**
 * Bootstraps an application from a application folder.
 *
 * @param {String} appDir The path to application folder.
 * @param {String} port The port the application will listen on.
 * @param {Function} [callback] Function to run when application finishes
 *   initializing.
 */
Application.bootstrap = function(appDir, port, callback) {
  var modes = [];
  var mergingSettings = [];
  ...
  application.start(port, callback);
};
